...
public class Ing extends JPanel {
    ...
    private JButton startButton,pauseButton; // button the user can click to start or abort the thread
    ...
    public Ing() {
        ...
        threadCountSelect.addItem("Usa 1 hilo");
        threadCountSelect.addItem("Usa 2 hilos");
        threadCountSelect.addItem("Usa 3 hilos");
        threadCountSelect.addItem("Usa 4 hilos");
        threadCountSelect.addItem("Usa 5 hilos");
        threadCountSelect.addItem("Usa 6 hilos");
        threadCountSelect.addItem("Usa 7 hilos");
        threadCountSelect.addItem("Usa 8 hilos");
