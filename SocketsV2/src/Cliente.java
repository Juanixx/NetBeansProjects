...
public class Cliente {
	public static void main(String argv[]) {
		...
		Socket socket = null;
		try { 
			//Obtenemos la direcciÃ³n IP del servidor
			...
			// Creamos el socket y establecemos la conexiÃ³n con el servidor
			...
			// Cerramos los flujos y el socket para liberar la conexiÃ³n
			sSalida.close();
			sEntrada.close();
