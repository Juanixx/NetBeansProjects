 ...
 * @author User
 */
public class BorrarCliente extends javax.swing.JDialog {
     ...
     */
    public BorrarCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingresa el id del cliente que deseas eliminar :");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BorrarCliente dialog = new BorrarCliente(new javax.swing.JFrame(), true);
